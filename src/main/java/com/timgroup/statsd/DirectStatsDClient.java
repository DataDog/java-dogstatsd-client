...
/**
 * DirectStatsDClient is an experimental extension of {@link StatsDClient} that allows for direct
 * access to some dogstatsd features.
 *
 * <p>It is not recommended to use this client in production. This client might allow you to take
 * advantage of new features in the agent before they are released, but it might also break your
 * application.
 */
public interface DirectStatsDClient extends StatsDClient {
     ...
     *
     * <p>The method doesn't take care of breaking down the values array if it is too large. It's up
     * to the caller to make sure the size is kept reasonable.
     *
