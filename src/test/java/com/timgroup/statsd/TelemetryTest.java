...
public class TelemetryTest {
    ...
    private static final StatsDClientErrorHandler LOGGING_HANDLER =
            new StatsDClientErrorHandler() {
    ...
    private static String computeTelemetryTags() throws IOException, Exception {
        ...
        return "client:java,"
                + NonBlockingStatsDClient.CLIENT_VERSION_TAG
                + properties.getProperty("dogstatsd_client_version")
    ...
    public void start() throws IOException, Exception {
        ...
        NonBlockingStatsDClientBuilder builder =
                new NonBlockingStatsDClientBuilder()
                        ...
                        .enableTelemetry(
                                false); // disable telemetry so we can control calls to "flush"
        if (containerID != null) {
    ...
    public void telemetry_incrManuallyIncrData() throws Exception {
        ...
        assertThat(
                statsdMessages,
                hasItem(
                        "datadog.dogstatsd.client.metrics_by_type:2|c|#test,"
                                + telemetryTags
                                + ",metrics_type:gauge"
                                + tail));
        ...
        assertThat(
                statsdMessages,
                hasItem(
                        "datadog.dogstatsd.client.service_checks:3|c|#test,"
                                + telemetryTags
                                + tail));
        ...
        assertThat(
                statsdMessages,
                hasItem(
                        "datadog.dogstatsd.client.bytes_dropped:5|c|#test,"
                                + telemetryTags
                                + tail));
        ...
        assertThat(
                statsdMessages,
                hasItem(
                        "datadog.dogstatsd.client.packets_dropped:7|c|#test,"
                                + telemetryTags
                                + tail));
        ...
        assertThat(
                statsdMessages,
                hasItem(
                        "datadog.dogstatsd.client.packets_dropped_queue:8|c|#test,"
                                + telemetryTags
                                + tail));
        ...
        assertThat(
                statsdMessages,
                hasItem(
                        "datadog.dogstatsd.client.aggregated_context:9|c|#test,"
                                + telemetryTags
                                + tail));
        ...
        assertThat(
                statsdMessages,
                hasItem(
                        "datadog.dogstatsd.client.aggregated_context_by_type:10|c|#test,"
                                + telemetryTags
                                + ",metrics_type:gauge"
                                + tail));
        ...
        assertThat(
                statsdMessages,
                hasItem(
                        "datadog.dogstatsd.client.aggregated_context_by_type:11|c|#test,"
                                + telemetryTags
                                + ",metrics_type:count"
                                + tail));
        ...
        assertThat(
                statsdMessages,
                hasItem(
                        "datadog.dogstatsd.client.aggregated_context_by_type:12|c|#test,"
                                + telemetryTags
                                + ",metrics_type:set"
                                + tail));
    }
    ...
    public void telemetry_incrMetricsSent() throws Exception {
        ...
        assertThat(
                statsdMessages,
                hasItem(
                        "datadog.dogstatsd.client.service_checks:0|c|#test,"
                                + telemetryTags
                                + tail));
        ...
        assertThat(
                ...
                hasItem(
                        String.format(
                                "datadog.dogstatsd.client.bytes_sent:%d|c|#test,%s%s",
                                28 + tail.length(), telemetryTags, tail)));

        assertThat(
                statsdMessages,
                hasItem(
                        "datadog.dogstatsd.client.bytes_dropped:0|c|#test,"
                                + telemetryTags
                                + tail));
        ...
        assertThat(
                statsdMessages,
                hasItem(
                        "datadog.dogstatsd.client.packets_dropped:0|c|#test,"
                                + telemetryTags
                                + tail));
        ...
        assertThat(
                statsdMessages,
                hasItem(
                        "datadog.dogstatsd.client.packets_dropped_queue:0|c|#test,"
                                + telemetryTags
                                + tail));
        ...
        assertThat(
                statsdMessages,
                hasItem(
                        "datadog.dogstatsd.client.aggregated_context:0|c|#test,"
                                + telemetryTags
                                + tail));
    }
    ...
    public void telemetry_flushInterval() throws Exception {
        ...
        assertThat(
                statsdMessages,
                hasItem("datadog.dogstatsd.client.bytes_sent:0|c|#test," + telemetryTags + tail));
        assertThat(
                statsdMessages,
                hasItem(
                        "datadog.dogstatsd.client.bytes_dropped:0|c|#test,"
        ...
        assertThat(
                statsdMessages,
                hasItem("datadog.dogstatsd.client.packets_sent:0|c|#test," + telemetryTags + tail));
        assertThat(
                statsdMessages,
                hasItem(
                        "datadog.dogstatsd.client.packets_dropped:0|c|#test,"
    ...
    public void telemetry_droppedData() throws Exception {
        ...
        assertThat(
                clientError.telemetry.bytesDropped.get(),
                equalTo("my.prefix.gauge:24|g|#test".length() + tail.length()));
    }
